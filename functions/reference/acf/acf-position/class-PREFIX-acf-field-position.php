 ...
 */
class PREFIX_acf_field_position extends \acf_field {
	/**
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Button Position', 'TEXTDOMAIN' );
	...
	public function render_field( $field ) {
		...
		<ul class="js--position">
			<li>
				<button id="left" value="left">
					<img src="<?= $this->env['url']. '/assets/images/Left.png' ?>"  />
				</button>
			</li>
			<li>
				<button id="center" value="center">
					<img src="<?= $this->env['url']. '/assets/images/Center.png' ?>"  />
				</button>
			</li>
			<li>
				<button id="right" value="right">
					<img src="<?= $this->env['url']. '/assets/images/Right.png' ?>"  />
				</button>
			</li>
		</ul>
		<input
			type="hidden"
			class="setting-font-size js--position-input" 
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'PREFIX-position' );
		wp_enqueue_style( 'PREFIX-position' );
	}
}
