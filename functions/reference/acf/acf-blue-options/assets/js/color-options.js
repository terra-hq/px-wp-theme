...
(function ($) {
  ...
  function initialize_field($field) {
    ...
    $.each($($field.find(".js--blueoptions")),function(){
  ...
  if (typeof acf.add_action !== "undefined") {
     ...
     */
    acf.add_action("ready_field/type=blueoptions", initialize_field);
    acf.add_action("append_field/type=blueoptions", initialize_field);
  }
})(jQuery);
